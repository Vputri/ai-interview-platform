        ...
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-8">
            ...
            <Link to="/assessments" className="flex items-center gap-2.5 group">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-teal-500 to-teal-700 text-white shadow-xs group-hover:scale-105 transition-transform">
